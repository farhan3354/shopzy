    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-blue-50">
        ...
        <div className="absolute inset-0 z-20 flex items-center">
          <div className="max-w-7xl mx-auto px-4 md:px-8 w-full">
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#4A90E2] to-[#357ABD] backdrop-blur-sm rounded-full text-white text-sm font-medium mb-6 animate-fade-in-up">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 leading-tight animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                We're <span className="bg-gradient-to-r from-[#4A90E2] via-[#E3F2FD] to-[#357ABD] bg-clip-text text-transparent">Reimagining</span> E-commerce
              </h1>
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
                <Link
                  to="/products"
                  className="group relative overflow-hidden bg-gradient-to-r from-[#4A90E2] to-[#357ABD] text-white px-8 py-4 rounded-full font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300 transform hover:-translate-y-1"
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-[#357ABD] to-[#4A90E2] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </Link>
                <Link
                  to="/register"
      ...
      <section className="py-16 md:py-24 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 text-[#4A90E2] font-semibold mb-4">
                <div className="w-2 h-2 bg-[#4A90E2] rounded-full" />
                OUR JOURNEY
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
                From <span className="text-[#4A90E2]">Dream</span> to <span className="text-[#357ABD]">Reality</span>
              </h2>
              ...
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="text-2xl font-bold bg-gradient-to-r from-[#4A90E2] to-[#357ABD] bg-clip-text text-transparent">
                      {achievement.value}
                    </div>
                  </div>
                ))}
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              The <span className="bg-gradient-to-r from-[#4A90E2] to-[#357ABD] bg-clip-text text-transparent">ShopNex</span> Difference
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-100 group-hover:border-gray-200 transition-colors relative z-10">
                    <div className="w-0 group-hover:w-full h-0.5 bg-gradient-to-r from-[#4A90E2] to-[#357ABD] transition-all duration-500" />
                  </div>
                </div>
              );
            })}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900">
                Creating <span className="text-[#4A90E2]">Unforgettable</span> Experiences
              </h3>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Journey Through <span className="bg-gradient-to-r from-[#4A90E2] to-[#357ABD] bg-clip-text text-transparent">Time</span>
            </h2>
          ...
          <div className="relative">
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-[#4A90E2] via-[#E3F2FD] to-[#4A90E2]" />
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  ...
                  <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2">
                    <div className="w-6 h-6 bg-[#4A90E2] rounded-full border-4 border-gray-900 shadow-lg group-hover:scale-125 transition-transform duration-300" />
                  </div>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              What <span className="bg-gradient-to-r from-[#4A90E2] to-[#357ABD] bg-clip-text text-transparent">Drives</span> Us
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {values.map((value, index) => (
              <div key={index} className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100 group-hover:border-gray-200 transition-colors">
                  <div className="w-0 group-hover:w-full h-0.5 bg-gradient-to-r from-[#4A90E2] to-[#357ABD] transition-all duration-300" />
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#4A90E2]/90 via-[#357ABD]/90 to-[#4A90E2]/90" />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="group bg-white text-[#4A90E2] px-10 py-4 rounded-full font-bold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 transform hover:-translate-y-1"
            >
...
export default About;
      ...
      //       </div>
      //       <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
      //         The <span className="bg-gradient-to-r from-[#4A90E2] to-[#357ABD] bg-clip-text text-transparent">Hearts</span> Behind Our Success
      //       </h2>
      //       <p className="text-xl text-gray-600 max-w-2xl mx-auto">
      ...
      //                 <p className="text-[#4A90E2] font-semibold">{member.role}</p>
      //               </div>
      //               <div className="w-12 h-12 bg-gradient-to-br from-[#4A90E2] to-[#357ABD] rounded-xl flex items-center justify-center text-white text-xl">
      ...
      //           {/* Hover Effect Line */}
      //           <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#4A90E2] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      //         </div>
      //       ))}
      //     </div>
      //   </div>
